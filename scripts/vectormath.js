...
define([
  ...
  var Vector4 = exports.Vector4 = class Vector4 extends BaseVector {
    ...
    multVecMatrix(matrix) {
      ...
      this[0] = w*matrix.$matrix.m41+x*matrix.$matrix.m11+y*matrix.$matrix.m21+z*matrix.$matrix.m31+w*matrix.$matrix.m41;
      this[1] = w*matrix.$matrix.m42+x*matrix.$matrix.m12+y*matrix.$matrix.m22+z*matrix.$matrix.m32+w*matrix.$matrix.m42;
      this[2] = w*matrix.$matrix.m43+x*matrix.$matrix.m13+y*matrix.$matrix.m23+z*matrix.$matrix.m33+w*matrix.$matrix.m43;
  ...
  let Vector2 = exports.Vector2 = class Vector2 extends BaseVector {
    constructor(data) {
      super();
    ...
    mulVecQuat(q) {
      ...
      let t0=-this[1]*this[0]-z*this[1]-w*z;
      let t1=this[0]*this[0]+z*z-w*this[1];
      let t2=this[0]*this[1]+w*this[0]-this[1]*z;
